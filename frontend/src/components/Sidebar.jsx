...
export default function Sidebar({ usuario, setVista, vistaActual, onLogout }) {
    ...
    return (
        <>
            ...
            <aside 
                className={`
                    fixed lg:relative bg-slate-900 h-full text-white min-h-screen transition-all duration-300 flex flex-col z-50
                    ${expandido ? 'w-64' : 'w-20'}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {expandido && (
                            <div className="overflow-hidden">
                                <h1 className="font-black text-xl tracking-tighter leading-none whitespace-nowrap">Telas System</h1>
